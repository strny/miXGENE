...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'HelpBlock.block_description'
        db.add_column(u'webapp_helpblock', 'block_description',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)

        # Deleting field 'HelpBlockAttribute.attribute_description'
        db.delete_column(u'webapp_helpblockattribute', 'attribute_description')

        # Adding field 'HelpBlockAttribute.parameters_description'
        db.add_column(u'webapp_helpblockattribute', 'parameters_description',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'HelpBlock.block_description'
        db.delete_column(u'webapp_helpblock', 'block_description')

        # Adding field 'HelpBlockAttribute.attribute_description'
        db.add_column(u'webapp_helpblockattribute', 'attribute_description',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)

        # Deleting field 'HelpBlockAttribute.parameters_description'
        db.delete_column(u'webapp_helpblockattribute', 'parameters_description')
    ...
    models = {
        ...
        u'webapp.geoterm': {
            'Meta': {'object_name': 'GEOTerm'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'term_genes': ('django.db.models.fields.TextField', [], {}),
            'term_name': ('django.db.models.fields.CharField', [], {'max_length': '512'})
        },
        u'webapp.helpblock': {
            'Meta': {'object_name': 'HelpBlock'},
            'block_description': ('django.db.models.fields.TextField', [], {}),
            'block_name': ('django.db.models.fields.CharField', [], {'max_length': '512'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        u'webapp.helpblockattribute': {
            'Meta': {'object_name': 'HelpBlockAttribute'},
            'attribute_name': ('django.db.models.fields.CharField', [], {'max_length': '512'}),
            'help_block': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['webapp.HelpBlock']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'parameters_description': ('django.db.models.fields.TextField', [], {})
        },
        u'webapp.refseq': {
