...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Experiment.is_run'
        db.add_column(u'webapp_experiment', 'is_run',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Experiment.parent_exp'
        db.add_column(u'webapp_experiment', 'parent_exp',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['webapp.Experiment'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Experiment.is_run'
        db.delete_column(u'webapp_experiment', 'is_run')

        # Deleting field 'Experiment.parent_exp'
        db.delete_column(u'webapp_experiment', 'parent_exp_id')
