...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'GEOTerm'
        db.create_table(u'webapp_geoterm', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('term_name', self.gf('django.db.models.fields.CharField')(max_length=512)),
            ('term_genes', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal(u'webapp', ['GEOTerm'])


    def backwards(self, orm):
        # Deleting model 'GEOTerm'
        db.delete_table(u'webapp_geoterm')
