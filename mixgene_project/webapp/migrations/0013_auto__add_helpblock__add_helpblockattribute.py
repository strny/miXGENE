...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'webapp_helpblock', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('block_name', self.gf('django.db.models.fields.CharField')(max_length=512)),
        ))
        db.send_create_signal(u'webapp', ['HelpBlock'])

        # Adding model 'HelpBlockAttribute'
        db.create_table(u'webapp_helpblockattribute', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('help_block', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['webapp.HelpBlock'])),
            ('attribute_name', self.gf('django.db.models.fields.CharField')(max_length=512)),
            ('attribute_description', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal(u'webapp', ['HelpBlockAttribute'])


    def backwards(self, orm):
        # Deleting model 'HelpBlock'
        db.delete_table(u'webapp_helpblock')

        # Deleting model 'HelpBlockAttribute'
        db.delete_table(u'webapp_helpblockattribute')
    ...
    models = {
        ...
        u'webapp.helpblockattribute': {
            ...
            'attribute_description': ('django.db.models.fields.TextField', [], {}),
