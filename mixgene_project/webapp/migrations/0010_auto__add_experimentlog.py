...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'webapp_experimentlog', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('experiment', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['webapp.Experiment'])),
            ('block_uuid', self.gf('django.db.models.fields.CharField')(default='', max_length=31)),
            ('severity', self.gf('django.db.models.fields.CharField')(default='INFO', max_length=31)),
            ('message', self.gf('django.db.models.fields.TextField')(default='')),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'webapp', ['ExperimentLog'])


    def backwards(self, orm):
        # Deleting model 'ExperimentLog'
        db.delete_table(u'webapp_experimentlog')
