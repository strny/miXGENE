...
class WalkForest(GenericClassifier):
    ...
    gene2gene = InputBlockField(name="gene2gene", order_num=30,
                                ...
                                required=True)
    gene2miRNA = InputBlockField(name="gene2miRNA", order_num=40,
                               required_data_type="BinaryInteraction",
                               required=True)
    ...
    def collect_options(self):
        self.collect_option_safe("gene2gene")
        self.collect_option_safe("gene2miRNA")
        self.classifier_options['walk_lengths'] = range(1, int(self.get_input_var("walk_max_length")))
        ...
        self.collect_option_safe("bootstrap")
